...
/**
 * This enum contains different scaling parameters for the gyroscope readings.
 */
enum G_SCALE {
    GFS_250DPS = 0,
    GFS_500DPS,
...
/**
 * This enum contains different scaling parameters for the magnetometer readings.
 */
enum M_SCALE {
...
/**
 * This enum contains two different polling modes for the magnetometer
 */
enum M_MODE {
...
/**
 * This namespace contains Memory addresses for registers and internal commands of the MPU9250.
 * Most are left unused but are not removed in case of future improvements.
 */
namespace MPU9250 {
    enum RegAddr {
